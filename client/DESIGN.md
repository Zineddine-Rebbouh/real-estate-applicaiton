...
- Full-width bar, `max-w-8xl` inner container, `mx-auto`, `px-6 lg:px-8`, height ~`72px`.
...
- Content wrapped in `max-w-8xl mx-auto px-6 lg:px-8`, vertically centered (`flex flex-col items-start justify-center h-full`) or bottom-aligned near a search panel.
...
- Content width: `max-w-8xl mx-auto px-6 lg:px-8` for all sections except full-bleed imagery.
...
| `xl`/`2xl`                                                           | Container hits `max-w-8xl` and stops growing — extra viewport width becomes side margin, not wider content | —                                                                                                                                       | —                                                                | —                                                          | —                                      |
