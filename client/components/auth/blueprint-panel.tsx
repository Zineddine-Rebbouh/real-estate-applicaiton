    ...
    >
      ...
      >
        ...
        <g className="building-front">
          ...
          <path className="blueprint-line" d="M 200 700 L 200 800 L 280 800 L 280 700 Z" />
          <path className="blueprint-line" d="M 360 700 L 360 800 L 440 800 L 440 700 Z" />
          <path className="blueprint-line" d="M 520 700 L 520 800 L 600 800 L 600 700 Z" />

          {/* Windows - second floor */}
          <path className="blueprint-line" d="M 200 550 L 200 630 L 280 630 L 280 550 Z" />
          <path className="blueprint-line" d="M 360 550 L 360 630 L 440 630 L 440 550 Z" />
          <path className="blueprint-line" d="M 520 550 L 520 630 L 600 630 L 600 550 Z" />

          {/* Windows - third floor */}
          <path className="blueprint-line" d="M 200 400 L 200 480 L 280 480 L 280 400 Z" />
          <path className="blueprint-line" d="M 360 400 L 360 480 L 440 480 L 440 400 Z" />
          <path className="blueprint-line" d="M 520 400 L 520 480 L 600 480 L 600 400 Z" />
          ...
          {/* Door */}
          <path className="blueprint-line" d="M 370 850 L 370 730 L 430 730 L 430 850" />
